...
const submit = () => {
    form.post(route('admin.scents.store'), {
...
<template>
    <AdminLayout>
        <Head title="Add New Scent" />
        <div class="surface-ground px-4 py-8 md:px-6 lg:px-8">
            <div class="text-900 font-medium text-xl mb-3">Add New Scent</div>
            <ValidationErrors />
            <form @submit.prevent="submit">
                <div class="surface-card p-4 shadow-2 border-round">
                    <div class="grid formgrid p-fluid">
                        ...
                        <div class="col-12">
                            <Button type="submit" label="Add Scent" class="w-auto mt-3"></Button>
                        </div>
                    </div>
                </div>
            </form>
